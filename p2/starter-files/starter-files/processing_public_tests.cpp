...
void test_energy(const Matrix *energy_mat, string prefix){
  ...
  //Matrix_print(energy_mat, cout);  ////////wzh added matrix print method 1
  // ostringstream s,a;  ////////wzh added matrix print method 2
  // Matrix_print(energy_mat, s);  ////////wzh added matrix print method 2
  // cout << "my energy"<< endl; ////////wzh added
  // cout<<s.str(); ////////wzh added matrix print method 2
  ...
  // cout << "correct energy"<< endl; ////////wzh added
  // Matrix_print(energy_mat_correct, a);  ////////wzh added matrix print method 2
  // cout << "my energy"<< endl; ////////wzh added
  // cout<<a.str(); ////////wzh added matrix print method 2
...
void test_cost(const Matrix *cost_mat, string prefix){
  ...
  // ostringstream s,a;  ////////wzh added matrix print method 2
  // Matrix_print(cost_mat, s);  ////////wzh added matrix print method 2
  // cout << "my cost"<< endl; ////////wzh added
  // cout<<s.str(); ////////wzh added matrix print method 2
  // Matrix_print(cost_mat_correct, a);  ////////wzh added matrix print method 2
  // cout << "correct cost"<< endl; ////////wzh added
  // cout<<a.str(); ////////wzh added matrix print method 2
